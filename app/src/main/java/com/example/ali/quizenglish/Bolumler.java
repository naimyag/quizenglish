...
public class Bolumler {
    ...
    public Bolumler(){
        ...
        bolumler.add(new Bolum(1,2));
        bolumler.add(new Bolum(2,2));
        bolumler.add(new Bolum(3,1));
        bolumler.add(new Bolum(4,3));
        bolumler.add(new Bolum(5,3));
        bolumler.add(new Bolum(6,2));
        bolumler.add(new Bolum(7,1));
        bolumler.add(new Bolum(8,1));
        bolumler.add(new Bolum(9,0));
        bolumler.add(new Bolum(10,0));
        bolumler.add(new Bolum(11,0));
        bolumler.add(new Bolum(12,0));
